...
class GUZECommand(cmd.Cmd):
    ...
    def print_console_result_table(self, result):
        """
        A method used to print console result table
        """
    ...
    def print_console_error_table(self, name):
        """
        A method used to print console error table
        """
